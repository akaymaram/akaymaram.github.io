<div class="about-header">
	<img src="assets/profile.jpeg" alt="Ala Kaymaram" class="about-avatar" width="160" height="160" loading="lazy" />
	...
	-->
	<a href="https://github.com/akaymaram" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
	...
	-->
	<a href="https://www.linkedin.com/in/kaymaram" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
	...
	-->
	<a href="mailto:alakaymaram@icloud.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
current focus area: Graph Data Science, MLOps<br>
