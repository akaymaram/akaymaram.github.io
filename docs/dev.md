...
<li>Isnad network visualization (digital humanities/graph data science)(<a href="graph.html">interactive network visualization using pyvis</a>)</li>
...
<li>Realtime Trade Intelligence Dashboard(avg. 3M shares (stocks & ETFs) & $200M in mutual fund orders per day)</li>
<li>Survival analysis + dimensionality reduction using <a href="https://umap-learn.readthedocs.io/en/latest/">UMAP</a> on +200M case records across 3 decades</li>
